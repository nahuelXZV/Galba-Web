<div class="mt-5">
    <div class="card" style="padding: 15px 15px; margin: 5px 0px">
        ...
        <!-- Modal toggle -->
        <button data-modal-target="defaultModal" data-modal-toggle="defaultModal" id="btnModal"
        ...
        <script>
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventClick: function(info) {
                    ...
                    var html =
                        '<div class="row"><div class="col-12 text-left"><h5>' +
                    ...
                    // obtener el elemento html por el id modalTitle y modalBody y asignarle el valor correspondiente
