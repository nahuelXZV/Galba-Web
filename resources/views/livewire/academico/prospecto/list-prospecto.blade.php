<div class="mt-5">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <x-iconos.flecha />
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-500">Prospectos</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                @foreach ($prospectos as $prospecto)
                    <tr
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="{{ route('prospecto.edit', $prospecto->id) }}"
                            ...
                            <button type="button" wire:click="delete({{ $prospecto->id }})"
        ...
        <x-shared.pagination :modelo='$prospectos' />
    </div>
