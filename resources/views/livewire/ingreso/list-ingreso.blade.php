        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <x-iconos.flecha />
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-500">Ingresos</span>
                </div>
            </li>
        </ol>
    </nav>
                ...
                @foreach ($ingresos as $ingreso)
                    <tr
                        ...
                        <td class="px-2 py-4 text-right">
                            ...
                            <button type="button" wire:click="delete({{ $ingreso->id }})"
