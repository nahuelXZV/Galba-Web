<div class="mt-5">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <x-iconos.flecha />
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-500">Activos</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <tbody>
                @foreach ($activos as $activo)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <img src="{{ $activo->dir }}" alt="{{ $activo->nombre }}" class="w-40 h-auto"><br>
                        </td>
                        <td class="px-6 py-4">
                            {{ $activo->codigo }}
                        </td>
                        ...
                        <td class="px-6 py-4 text-right">
                            ...
                            <button type="button" wire:click="delete({{ $activo->id }})"
        ...
        <x-shared.pagination :modelo='$activos' />
    </div>
