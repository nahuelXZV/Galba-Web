<div class="mt-5">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <x-iconos.flecha />
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-500">Inventario</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <tbody>
                @foreach ($inventarios as $inventario)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <img src="{{ $inventario->dir }}" alt="{{ $inventario->nombre }}" class="w-40 h-auto"><br>
                        </td>
                        <td class="px-6 py-4">
                            {{ $inventario->codigo }}
                        </td>
                        <td class="px-6 py-4">
                            {{ $inventario->nombre }} <br>
                        ...
                        <td class="px-6 py-4 text-right">
                            ...
                            <button type="button" wire:click="delete({{ $inventario->id }})"
        ...
        <x-shared.pagination :modelo='$inventarios' />
    </div>
