<div>
    <div class="bg-white dark:bg-gray-800 p-4 rounded-md">
        <div class="flex items-center justify-between">
            ...
            <a href="#" class="text-base font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500">Ver
        ...
        <div class="grid grid-cols-4">
            <div
                ...
                <a href="#">
                    <img class="p-8 rounded-t-lg" src="{{ asset('img/ex1.png') }}" alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
